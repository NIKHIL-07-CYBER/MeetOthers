...
const ChatSidebar = ({ isOpen, onClose, roomId }) => {
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: 'System',
      content: 'Welcome to the meeting! Chat messages are end-to-end encrypted.',
  ...
  const sendMessage = () => {
    ...
    // Simulate receiving a response (in real app, this would be through WebSocket)
    setTimeout(() => {
